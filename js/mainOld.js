...
function updatePositions() {
 ...
 /******** Change!! changed selector name to improve speed *********/
  var items = document.querySelectorAll('.mover');
 /******** Change!! took out of for loop to improve speed **********/
  var calc = (document.body.scrollTop / 1250) ;

  for (var i = 0; i < items.length; i++) {
    var phase = Math.sin( calc + (i % 5));
   /********** Change!! added the style Translate3d to optimize speed ********8*/ 
    items[i].style.translate = 'translate3d(' + (100 * phase) + 'px, 1, 1)';
  };
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256; // ********* changed from 200 to 32 ***********
  for (var i = 0; i < 32; i++) {
